...
<template>
  ...
  <div>
    <div class="maxWidth tw-px-3 !tw-mt-10 tw-py-10 ">
      <v-row>
  ...
  <div class="tw-bg-gray-100 !tw-my-10 tw-py-10 tw-w-full">
  ...
  <div class="maxWidth tw-px-3 ">
    <v-row class=" tw-mx-auto tw-justify-center !tw-mb-5" >
      <v-col cols="10">
        <h2 class="tw-text-center tw-text-primary tw-text-4xl tw-font-bold">Como funciona?</h2>
      </v-col>
      <v-col cols="10">
        <div class="tw-relative tw-bg-white tw-shadow-md tw-rounded-lg tw-border tw-border-gray-200  tw-p-6 tw-pl-12">
          <div class="tw-absolute tw-left-0 tw-top-1/2 tw-transform tw--translate-x-1/2 tw--translate-y-1/2 tw-w-8 tw-h-8 tw-flex tw-items-center tw-justify-center tw-bg-primary tw-text-white tw-font-bold tw-rounded-full">
            1
          </div>
          <div class="tw-flex tw-items-start">
            <div class="tw-flex-shrink-0 tw-mr-3">
              <Icon icon="iconoir:journal-page" class="tw-text-[50px] tw-text-secondary  " />
            </div>
            <div>
      ...
      <v-col cols="10">
        <div class="tw-relative tw-bg-white tw-shadow-md tw-rounded-lg tw-border tw-border-gray-200  tw-p-6 tw-pl-12">
          ...
          <div class="tw-flex tw-items-start">
            <div class="tw-flex-shrink-0 tw-mr-3">
              <Icon icon="solar:user-id-outline" class="tw-text-[50px] tw-text-secondary  " />
            </div>
            <div>
              <p class="tw-text-gray-700">
                Feito o cadastro e comprado sua passagem, uma mensagem via e-mail é enviada automaticamente para o seu e-mail de cadastro onde além das instruções de embarque, você também recebe sua passagem no formato PDF.
              </p>
            </div>
          </div>
        </div>
      ...
      <v-col cols="10">
        <div class="tw-relative tw-bg-white tw-shadow-md tw-rounded-lg tw-border tw-border-gray-200  tw-p-6 tw-pl-12">
          ...
          <div class="tw-flex tw-items-start">
            <div class="tw-flex-shrink-0 tw-mr-3">
              <Icon icon="line-md:email-opened-multiple" class="tw-text-[50px] tw-text-secondary  " />
            </div>
            <div>
              <p class="tw-text-gray-700">
                Quando logado, você terá uma área do cliente onde tem a sessão/página Minhas Passagens, de onde também pode extrair e embarcar.
              </p>
            </div>
          </div>
        </div>
      ...
      <v-col cols="10">
        <div class="tw-relative tw-bg-white tw-shadow-md tw-rounded-lg tw-border tw-border-gray-200  tw-p-6 tw-pl-12">
          ...
          <div class="tw-flex tw-items-start">
            <div class="tw-flex-shrink-0 tw-mr-3">
              <Icon icon="cil:qr-code" class="tw-text-[50px] tw-text-secondary  " />
            </div>
            <div>
              <p class="tw-text-gray-700">
                Destacando que não é necessário a impressão do bilhete, pode apresentar de forma eletrônica na tela do seu celular, acompanhado de um documento de identificação.
              </p>
            </div>
          </div>
        </div>
